...
export class OpenSkyService {
  ...
  getAllStateVectors(time?: number, icao24?: string[], lamin?: number, lomin?: number, lamax?: number, lomax?: number): Observable<StateVectorResponse> {
    ...
    if (lamin !== undefined && lomin !== undefined && lamax !== undefined && lomax !== undefined) {
      params = params.append('lamin', lamin.toString())
        .append('lomin', lomin.toString())
        .append('lamax', lamax.toString())
        .append('lomax', lomax.toString());
    }
